    ...
    <div class="shop">
        ...
        <section class="shopInfo">
            <div class="shop-header-main_1B2kH_0">
                <img class="shop-header-logo_3woDQ_0" src="https://fuss10.elemecdn.com/f/db/4e3454fcacc68667ef8ee8832179cjpeg.jpeg?imageMogr/format/webp/thumbnail/!130x130r/gravity/Center/crop/130x130/"> <div class="shop-header-content_3UjPs_0"><h2 class="shop-header-shopName_2QrHh_0">放牛斑（滨北官任店）</h2>
                ...
                <div class="shop-header-notice_2DzmG_0">
                    <span>公告：</span>
                    <span>
                    各位放牛斑的粉丝，请在饮料下单的时候备注一下购买饮料的需求：1、甜度选择（多糖、正常糖、少糖、半塘、微糖、无糖）。2、放牛斑会员卡的手机号，以便我们帮您把积分积进去喔！3、选购加料（波霸、燕麦、红豆）的时候要备注清楚加料要加在哪一杯饮料中，确保我们给您的饮料是无误的，谢谢！
                 </span>
                </div>
            </div>
            </div>
