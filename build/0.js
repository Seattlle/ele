...
Component.options.__file = "D:\\Program\\ele\\src\\components\\shop\\cart.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-32761b0a", Component.options)
  } else {
    hotAPI.reload("data-v-32761b0a", Component.options)
  }
...
Component.options.__file = "D:\\Program\\ele\\src\\components\\shop\\comment.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d4502e5", Component.options)
  } else {
    hotAPI.reload("data-v-2d4502e5", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "D:\\Program\\ele\\src\\components\\shop\\commentList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b47cabba", Component.options)
  } else {
    hotAPI.reload("data-v-b47cabba", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "D:\\Program\\ele\\src\\components\\shop\\shopOrder.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cc67bb04", Component.options)
  } else {
    hotAPI.reload("data-v-cc67bb04", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "menu-category": _vm.shop.menuCategory,
      "send-price": _vm.shop.sendPrice
    }
  }), _vm._v(" "), _c('comment', {
    directives: [{
      name: "show",
    ...
    attrs: {
      "comments": _vm.shop.commentList,
      "overall-score": _vm.shop.overallScore,
      "good-num": _vm.shop.goodNum,
      "send-time": _vm.shop.sendTime,
      "service-num": _vm.shop.serviceNum
    }
  })], 1)])
},staticRenderFns: []}
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(2).rerender("data-v-1d7d9fe0", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.overallScore))]), _vm._v(" "), _c('div', [_vm._v("综合评价")]), _vm._v(" "), _c('p', {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(2).rerender("data-v-2d4502e5", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('span', [_vm._v(_vm._s(_vm._f("toMoney")(_vm.totalMoney)))])]), _vm._v(" "), _c('p', {
    staticClass: "bottomNav-3zqFz_0"
  }, [_vm._v("配送费" + _vm._s(_vm._f("toMoney")(_vm.sendPrice)))])]), _vm._v(" "), _c('a', {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(2).rerender("data-v-32761b0a", module.exports)
  }
}
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(2).rerender("data-v-b47cabba", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', {
    ...
    attrs: {
      "total-money": _vm.totalMoney,
      "send-price": _vm.sendPrice,
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(2).rerender("data-v-cc67bb04", module.exports)
  }
}
...
var update = __webpack_require__(6)("88a06c96", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("48228188", content, false, {});
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("7bd57b1d", content, false, {});
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("483a0051", content, false, {});
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("b95fa5a4", content, false, {});
// Hot Module Replacement
if(true) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
Component.options.__file = "D:\\Program\\ele\\src\\components\\shop\\shop.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d7d9fe0", Component.options)
  } else {
    hotAPI.reload("data-v-1d7d9fe0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
    props: ["totalMoney", "sendPrice", "totalNum"]
};
...
exports.default = {
    props: ["comments", "overallScore", "goodNum", "sendTime", "serviceNum"],
    data: function data() {
        return {};
    },
...
exports.default = {
    ...
    components: {
        shopOrder: _shopOrder2.default, comment: _comment2.default
    },
    methods: {
        getShopInfoById: function getShopInfoById() {
            this.showOrder = true;
...
exports.default = {
    ...
    methods: {
        ...
        scrollChoseMenu: function scrollChoseMenu(menuId) {
        ...
        method: function method(list, i) {
            if (typeof list.selectNum == 'undefined') {
                _vue2.default.set(list, 'selectNum', i);
            } else {
                list.selectNum += i;
            }
            if (i > 0) {
        ...
        addBall: function addBall(event) {
